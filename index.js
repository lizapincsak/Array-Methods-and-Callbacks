...
const worldCupFinal = fifaData.filter(data => data["Stage"] === "Final" && data["Year"] === 2014
);
...
return `Average Home Team Goals: ${homeAvg/data.length}. Away Team Goals ${awayAvg/data.length}`
